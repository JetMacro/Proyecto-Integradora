...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const apiUrl = "https://proyecto-integradora-production.up.railway.app/api/inventario/getAll";
...
window.guardarInventario = async () => {
    try {
        ...
        const response = await fetch("https://proyecto-integradora-production.up.railway.app/api/inventario/save", {
            method: "POST",
...
window.cargarEdificios = async () => {
    ...
    try {
        const resp = await fetch("https://proyecto-integradora-production.up.railway.app/api/inventario/getEdificios");
...
window.cargarSalones = async () => {
    ...
    try {
        const resp = await fetch(`https://proyecto-integradora-production.up.railway.app/api/inventario/getSalones?idEdificio=${valEdificio}`);
...
window.verDetalleMaterial = async (nombreMaterial) => {
    try {
        ...
        const response = await fetch(`https://proyecto-integradora-production.up.railway.app/api/inventario/getByName?nombre=${encodeURIComponent(nombreMaterial)}`);
        const data = await response.json();
...
window.eliminarItem = async (id) => {
    ...
    if (result.isConfirmed) {
        try {
            ...
            const response = await fetch(`https://proyecto-integradora-production.up.railway.app/api/inventario/delete`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
window.actualizarItem = async () => {
    ...
    await fetch(`https://proyecto-integradora-production.up.railway.app/api/inventario/update`, {
        method: 'POST',
        headers: {'Content-Type': 'application/json'},
        body: JSON.stringify(datos)
    });
